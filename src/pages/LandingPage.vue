  ...
  <div class="landing-wrapper">
    ...
    <section class="features-grid">
      <div class="feature-card">
        ...
        <h3 class="feature-title">Bucket</h3>
        <p class="feature-desc">bunga cantik dengan tema dan warna bucket sesuai selera.</p>
      </div>

      <div class="feature-card">
        <span class="feature-icon">🌹</span>
        <h3 class="feature-title">Bunga</h3>
        <p class="feature-desc">bunga fresh yang membuatmu menjadi goodmood.</p>
      </div>
      
      <div class="feature-card">
        <span class="feature-icon">🌱</span>
        <h3 class="feature-title">Pupuk</h3>
        <p class="feature-desc">pupuk alami yang mewmbuat tanamanmu menjadi segar.</p>
      </div>
    </section>
